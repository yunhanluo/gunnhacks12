  ...
  Future<void> _fetchPointsResponse() async {
    try {
      final result = await OpenAIService.askAI(
        systemMessage: "$defaultInstructions Make sure the argument supports the user's ${widget.input} view.",
